...
var AmateurBands = []BandDefinition{
	...
	{Name: "80M", MinFreqMHz: 3.500, MaxFreqMHz: 4.000, UseUSB: false},
...
// ✅ HELPER : FreqMhztoHz - Fonction de compatibilité avec l'ancien code
// Convertit une fréquence depuis différents formats vers MHz string
