...
var BandModeRanges = map[string][]ModeRange{
	...
	"20M": {
		...
		{MinFreqMHz: 14.083, MaxFreqMHz: 14.095, Mode: "FT8"},
		{MinFreqMHz: 14.095, MaxFreqMHz: 14.112, Mode: "RTTY"},
	...
	"12M": {
		...
		{MinFreqMHz: 24.922, MaxFreqMHz: 24.930, Mode: "RTTY"},
		{MinFreqMHz: 24.930, MaxFreqMHz: 24.990, Mode: "USB"},
	},
	"10M": {
		{MinFreqMHz: 28.000, MaxFreqMHz: 28.070, Mode: "CW"},
		{MinFreqMHz: 28.070, MaxFreqMHz: 28.096, Mode: "FT8"},
		{MinFreqMHz: 28.096, MaxFreqMHz: 28.179, Mode: "RTTY"},
